		...
		<div className='font-primary w-full p-10'>
			...
			<div className='grid grid-cols-2 gap-2'>
				...
				<div className='flex flex-row gap-4'>
					...
					<Tooltip
						title='Try to create itineraries generated by ChatGPT (This feature is currently unavailable)'
						placement='top'
						arrow>
						<button className='bg-primary opacity-70 text-white shadow-md rounded-md text-sm text-center px-4 py-2'>
